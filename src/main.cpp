...
const string strMessageMagic = "t01coin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // t01coin: 1 days
static const int64 nTargetSpacing = 120; // t01coin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal t01coin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "t01coin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbb9bbb58fe65db7118925a524fe15d8c5f9186885173a5ca334259c64624b827");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CNN: Crowd-funding site Kickstarter hacked; CEO urges password changes";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1392498168; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1392498168;
            block.nNonce   = 3932191;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x575e18fa10a1e8fc6c978b89fd707f1bcc19638991696c6aff4735db73898a7b"));
